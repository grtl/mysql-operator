...
var mysqlclustersResource = schema.GroupVersionResource{Group: "cr.mysqloperator.grtl.github.com", Version: "v1", Resource: "mysqlclusters"}

var mysqlclustersKind = schema.GroupVersionKind{Group: "cr.mysqloperator.grtl.github.com", Version: "v1", Kind: "MySQLCluster"}
...
func (c *FakeMySQLClusters) Get(name string, options v1.GetOptions) (result *cr_v1.MySQLCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(mysqlclustersResource, c.ns, name), &cr_v1.MySQLCluster{})

	if obj == nil {
		return nil, err
	}
	return obj.(*cr_v1.MySQLCluster), err
}
...
func (c *FakeMySQLClusters) List(opts v1.ListOptions) (result *cr_v1.MySQLClusterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(mysqlclustersResource, mysqlclustersKind, c.ns, opts), &cr_v1.MySQLClusterList{})
	...
	list := &cr_v1.MySQLClusterList{}
	for _, item := range obj.(*cr_v1.MySQLClusterList).Items {
...
func (c *FakeMySQLClusters) Create(mySQLCluster *cr_v1.MySQLCluster) (result *cr_v1.MySQLCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(mysqlclustersResource, c.ns, mySQLCluster), &cr_v1.MySQLCluster{})
...
func (c *FakeMySQLClusters) Update(mySQLCluster *cr_v1.MySQLCluster) (result *cr_v1.MySQLCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(mysqlclustersResource, c.ns, mySQLCluster), &cr_v1.MySQLCluster{})
...
func (c *FakeMySQLClusters) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(mysqlclustersResource, c.ns, name), &cr_v1.MySQLCluster{})
...
func (c *FakeMySQLClusters) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &cr_v1.MySQLClusterList{})
	return err
}
...
func (c *FakeMySQLClusters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *cr_v1.MySQLCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(mysqlclustersResource, c.ns, name, data, subresources...), &cr_v1.MySQLCluster{})
